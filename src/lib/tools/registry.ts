...
export const toolRegistry: Tool[] = [
  ...
  },
  {
    ...
    category: "Documents & Text",
    description: "Add sequential number stamps to PDF pages for legal, indexing, or auditing compliance.",
    acceptedFileTypes: ["application/pdf", ".pdf"],
    processingMode: "client",
    settingsSchema: [
  ...
  },
  {
    ...
    category: "Documents & Text",
    description: "Convert color layers of PDF document vector layers and images to grayscale.",
    acceptedFileTypes: ["application/pdf", ".pdf"],
    processingMode: "client",
    settingsSchema: [
      { name: "linearize", label: "Use object-stream optimization", type: "checkbox", defaultValue: true },
  ...
  },
  {
    ...
    name: "PDF Maker",
    category: "Documents & Text",
    description: "Create a clean, formatted PDF document from text entries and custom image attachments.",
    acceptedFileTypes: ["image/*"],
    processingMode: "client",
    settingsSchema: [
      { name: "pageSize", label: "Page Size", type: "select", options: ["A4", "Letter", "Legal"], defaultValue: "A4" },
      { name: "orientation", label: "Orientation", type: "select", options: ["Portrait", "Landscape"], defaultValue: "Portrait" },
      { name: "font", label: "Font Style", type: "select", options: ["Helvetica", "Times Roman", "Courier"], defaultValue: "Helvetica" },
    ],
  },
  {
    id: "converter",
